...
import com.rifdahalf.newsapp2.network.RetrofitConfig
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        if (status.equals("ok")) {
                            ...
                            title_breaking_item.text = newsData?.component1()?.title.toString()
                            tv_date_release_item.text = newsData?.component1()?.publishedAt.toString()
